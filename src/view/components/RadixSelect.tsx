...
export function RadixSelect({ className, placeholder, options, error, onChange, value }: SelectProps) {
    ...
    <div>
      <div className="relative">
        ...
        <RdxSelect.Root value={value} onValueChange={handleSelect}>
          <RdxSelect.Trigger
            className={cn(
              'bg-white w-full rounded-lg border border-gray-600 px-3 h-[52px] text-gray-800 focus:border-gray-800 transition-all outline-none text-left relative pt-4',
